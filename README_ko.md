...
BME280은 크기와 낮은 전력 소비가 주요 설계 매개변수인 모바일 애플리케이션 및 웨어러블용으로 특별히 개발된 습도 센서입니다. 이 장치는 높은 선형성과 높은 정확도의 센서를 결합하고 있으며 낮은 전류 소비, 장기 안정성 및 높은 EMC 견고성을 완벽하게 구현합니다. 습도 센서는 매우 빠른 응답 시간을 제공하므로 상황 인식 및 넓은 온도 범위에 대한 높은 정확도와 같은 새로운 애플리케이션에 대한 성능 요구 사항을 지원합니다.

LibDriver BME280은 LibDriver에서 출시한 BME280의 전체 기능 드라이버입니다. 압력, 온도 및 습도에 대한 지속적인 판독, 압력, 온도 및 습도에 대한 단일 판독 등을 제공합니다. LibDriver는 MISRA를 준수합니다.
...
/src 디렉토리에는 LibDriver BME280의 소스 파일이 포함되어 있습니다.

/interface 디렉토리에는 LibDriver BME280용 플랫폼 독립적인 IIC, SPI버스 템플릿이 포함되어 있습니다.

/test 디렉토리에는 LibDriver BME280드라이버 테스트 프로그램이 포함되어 있어 칩의 필요한 기능을 간단히 테스트할 수 있습니다.

/example 디렉토리에는 LibDriver BME280프로그래밍 예제가 포함되어 있습니다.

/doc 디렉토리에는 LibDriver BME280오프라인 문서가 포함되어 있습니다.

/datasheet 디렉토리에는 BME280데이터시트가 있습니다.
...
온라인 문서: [https://www.libdriver.com/docs/bme280/index.html](https://www.libdriver.com/docs/bme280/index.html).
